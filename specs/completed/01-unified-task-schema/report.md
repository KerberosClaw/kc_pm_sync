...
| `tests/fixtures/azure/work_item_670.json`（新） | 去敏後的 Azure Task #670 payload（acme→acme、demo_user→demo_user、UUID/GUID/descriptor 替換）|
...
- **public repo 風險**：fixture 去敏過，grep `acme|demo_user|chaing steve` 零 hit，可安全推 public
